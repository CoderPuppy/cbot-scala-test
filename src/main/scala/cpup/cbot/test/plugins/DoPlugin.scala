...
import cpup.cbot.plugin.commandPlugin.Arguments
...
//					e.context.bus.post(doEvent)
	...
	case class DoCommandEvent(bot: CBot, override val context: Context, reply: Replyable, ircUser: IRCUser, cmd: String, args: Arguments) extends TCommandEvent {
